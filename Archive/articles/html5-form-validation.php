...
<p>The first two techniques are commonly called <span class="key">front-end validation</span>, because the validation is done on the client browser before data is transmitted to the server. The third type of validation also known as back-end  validation, takes place on the server computer after the form has been submitted. </p>
