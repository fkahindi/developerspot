<div class="social-media">
    <!--Facebook button-->
    <a target="_blank" id="shareBtn" class="fa fa-facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url;?>"  data-layout="button" data-href="<?php echo $url;?>" ></a>
    <!--Twitter button-->
